        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SensitiveData = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2025, 11, 24, 5, 51, 27, 178, DateTimeKind.Utc).AddTicks(9381), "Regular client", true, "Client" },
                    { 2, new DateTime(2025, 11, 24, 5, 51, 27, 178, DateTimeKind.Utc).AddTicks(9384), "Barber professional", true, "Barber" },
                    { 3, new DateTime(2025, 11, 24, 5, 51, 27, 178, DateTimeKind.Utc).AddTicks(9384), "Barber manager with extended permissions", true, "Manager" },
                    { 4, new DateTime(2025, 11, 24, 5, 51, 27, 178, DateTimeKind.Utc).AddTicks(9385), "System administrator", true, "Administrator" },
                    { 5, new DateTime(2025, 11, 24, 5, 51, 27, 178, DateTimeKind.Utc).AddTicks(9385), "External auditor (temporary access)", true, "Auditor" }
                });

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_BarberId_DateTime",
                table: "Appointments",
                columns: new[] { "BarberId", "DateTime" });
